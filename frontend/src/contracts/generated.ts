...
/**
 * Wraps __{@link useReadContract}__ with `abi` set to __{@link forumAbi}__ and `functionName` set to `"postToComments"`
 */
export const useReadForumPostToComments = /*#__PURE__*/ createUseReadContract({
  abi: forumAbi,
  functionName: 'postToComments',
})
